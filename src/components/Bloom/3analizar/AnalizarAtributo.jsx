...
const itemsFromBackend = [
  { id: "Primero", content: "-marca: char" },
  { id: "Segundo", content: "-nombre: char" },
  { id: "Tercero", content: "-color: char" },
  { id: "Cuarto", content: "-edad: int" },
  { id: "Quinto", content: "-velocidad: double" },
  { id: "Sexto", content: "-correo: char" },
  { id: "Septimo", content: "-modelo: char" },
...
function AnalizarAtributo(props) {
/* Declaraciones */
...
/* Contenido */
  ...
  return (
    ...
    <div className='bloque-pregunta'>
            ...
            <span className='TextoPregunta'>Agrupe los atributos que corresponden a la clase auto, 
            seleccione y arrastre desde la columna de opciones hasta la columna llamada "Clase Vehículo".</span>
...
export default AnalizarAtributo;